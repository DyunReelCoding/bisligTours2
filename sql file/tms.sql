...
INSERT INTO `tblbooking` (`BookingId`, `PackageId`, `UserEmail`, `FromDate`, `ToDate`, `Comment`, `HotelId`, `HotelPrice`, `RegDate`, `status`, `CancelledBy`, `UpdationDate`) VALUES
(11, 1, 'user@example.com', '2024-11-20', '2024-11-25', 'Looking forward to the trip!', 2, 200.50, '2024-11-18 09:41:02', 0, NULL, NULL),
(12, 1, 'baloyo@gmail.com', '2024-11-05', '2024-11-12', '', 1, 150.00, '2024-11-18 09:45:47', 0, NULL, NULL),
(13, 1, 'baloyo@gmail.com', '2024-11-05', '2024-11-12', '', 1, 150.00, '2024-11-18 09:47:26', 0, NULL, NULL);
...
(1, 'Tinuy An Falls', 'General', 'BISLIG CITY', 10000, 'Transportation, Guided Tour, Activities, Meals, Miscellaneous Services', '1. Transportation:\r\nRoundtrip transfers: Private van or shared bus from your pick-up point to Tinuy-an Falls.\r\nOptional transfers from nearby cities (e.g., Butuan, Surigao, or Davao)\r\n\r\n2.. Guided Tour:\r\nLocal tour guide providing insights and history about Tinuy-an Falls.\r\nOptional side trips to nearby attractions (e.g., Enchanted River, Hinatuan).\r\n\r\n3. Activities:\r\nSwimming at the falls.\r\nBamboo raft rental to get closer to the cascading water.\r\nPhotography and sightseeing.\r\n\r\n4. Meals:\r\nPacked lunch or picnic-style meals near the falls.\r\nSnacks and bottled water.\r\n5. Miscellaneous Services:\r\nFree use of cottages or picnic huts (depending on package type).\r\nAssistance with itinerary customization.', 'Tinuy-an_Falls,_April_2011.jpg', '2017-05-13 14:23:44', '2024-11-18 09:05:26'),
...
(7, 'Hinayagan Cave', 'Family Package', 'BISLIG CITY', 5000, 'Transportation, Guided Tour, Activities, Meals, Miscellaneous Services', 'etc.etc.', 'cave-hinayagan.jpg', '2024-11-18 09:57:41', '0000-00-00 00:00:00');
...
(16, 'jonriel', '1234', 'baloyo@gmail.com', '1dc8ae73587982012f3c9b5157fa2ffa', '2024-11-18 09:10:06', '0000-00-00 00:00:00');
