									...
									foreach ($results as $result) {	?>
										...
										<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<input type="text" class="form-control1" name="packageprice" id="packageprice" placeholder=" Package Price is PESO" value="<?php echo htmlentities($result->PackagePrice); ?>" required>
												</div>
											</div>
